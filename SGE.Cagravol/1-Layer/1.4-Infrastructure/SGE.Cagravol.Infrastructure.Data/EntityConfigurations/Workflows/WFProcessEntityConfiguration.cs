...
{
    public class WFProcessEntityConfiguration: EntityTypeConfiguration<WFProcess>
    {
        public WFProcessEntityConfiguration()
        {
            this.HasKey(i => i.Id);
            ...
            this.ToTable("WFProcess", SchemaDefinitions.Dbo);
