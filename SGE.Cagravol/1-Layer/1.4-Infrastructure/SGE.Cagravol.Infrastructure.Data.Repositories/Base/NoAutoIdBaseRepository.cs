...
namespace SGE.Cagravol.Infrastructure.Data.Repositories.Base
{
	...
	public abstract class NoAutoIdBaseRepository<T> : IBaseNoAutoIdRepository<T>
		where T : class, IEntityNoAutoIdentity, new()
	{
		/// <summary>
		/// The current context
		/// </summary>
        ...
        public NoAutoIdBaseRepository(ISGEContext context)
		{
