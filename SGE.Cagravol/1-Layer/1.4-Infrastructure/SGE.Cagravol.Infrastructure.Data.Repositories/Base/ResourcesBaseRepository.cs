...
namespace SGE.Cagravol.Infrastructure.Data.Repositories.Base
{
    ...
    public abstract class ResourcesBaseRepository<T> : IBaseRepository<T>
        where T : class, IEntityIdentity, new()
    {
        ...
        public ResourcesBaseRepository(ISGEContext context)
        {
        ...
        public async Task<IResultServiceModel<T>> FindAsync(long id)
        {
            IResultServiceModel<T> rv = new ResultServiceModel<T>();
            try
            {
