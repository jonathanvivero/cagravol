(function (angular) {
    ...
    sge.controller('MySpaceResendFileController', ['$scope', '$routeParams', '$log', 'AppService', 'NetService', 'FlagService', 'EntityService', 'FileService', 'UtilService',
        function ($scope, $routeParams, $log, app, net, flag, entity, file, util) {
            ...
            app.setState('myspace.resendfile', $scope.id);
            ...
            var local = {
                ...
                recalculateEstimation: function () {
                    ...
                    $log.log('------------------------------------------------------------------------------------------------------------------------------------------');
                    $log.log('------------------------------------------------------------------------------------------------------------------------------------------');
                    $log.log('START::' + fileReader.startTime);
                    $log.log('NOW::::' + now);
                ...
                getFile: function () {
                    var data = { id: $scope.id, projectId: 0 }, 
