(function (angular) {
    ...
    sge.controller('MySpaceNewFileController', ['$scope', '$routeParams', '$log', 'AppService', 'NetService', 'FlagService', 'EntityService', 'FileService', 'UtilService',
        function ($scope, $routeParams, $log, app, net, flag, entity, file, util) {
            ...
            app.setState('myspace.newfile', $scope.pid);
            ...
            var local = {                
                ...
                doSendFile: function () {
                    ...
                    file.sendFile({
                        ...
                        fileNotes: $scope.item.fileNotes,
                        item: $scope.item,
